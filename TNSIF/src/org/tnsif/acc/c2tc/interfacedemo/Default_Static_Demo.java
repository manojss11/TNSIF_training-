...
interface Vehicle {
    ...
    default void repair() {
        System.out.println("We provide general vehicle repair service");
    }
...
class Car implements Vehicle {
    ...
    public void repair() {
        System.out.println("Car " + model + " repair service provided");
    }
}
...
class Bike implements Vehicle {
    ...
    public void repair() {
        System.out.println("Bike " + type + " repair service provided");
    }
}
